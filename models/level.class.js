...
class Level {
  ...
  constructor(enemies, clouds, backgroundObjects, coins, bottles, platforms) {
    ...
    this.movableObjects = this.getObjectsByClassName(
      this.allObjects,
      MovableObject
    );
    this.collidableObjects = this.getObjectsByClassName(
      this.allObjects,
      CollidableObject
    );
    this.destroyableObjects = this.getObjectsByClassName(
      this.allObjects,
      DestroyableObject
    );
    this.collectableObjects = this.getObjectsByClassName(
      this.allObjects,
      CollectibleObject
    );
